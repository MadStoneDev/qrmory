    ...
    <>
      <label className="control-label">
        ...
        <div className="flex flex-row flex-nowrap">
          <select
            ref={protocolRef}
            className="mr-2 mt-1 ring-0 border-0 outline-none focus-visible:ring-1 focus-visible:ring-qrmory-purple-500 focus:bg-neutral-100 rounded-xl text-sm md:text-base text-qrmory-purple-800 font-bold"
            value={protocol}
